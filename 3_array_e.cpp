...
//(for both only +ve eles, -ve and +ve eles)
...
//better approach (for +ve eles)- hashing
//optimal approach (for +ve and -ve eles)
int longestSubArr(vector<int>& arr, long long k){
    ...
    for (int i = 0; i < n; i++) {
        ...
        //sum of remaining part = current_sum - k
        long long rem = sum - k;
...
//optimal approach - two pointers - only for +ve arr elements
